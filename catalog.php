...
<body>
    ...
    <a href="cart_cbement.php">View your cart</a> |
    ...
    $_SESSION['cat'] = $incomingCategory;  // could do $category = $_SESSION['cat'] but if category changes, need to save it back to $_Session['cat'] to preserve it.
